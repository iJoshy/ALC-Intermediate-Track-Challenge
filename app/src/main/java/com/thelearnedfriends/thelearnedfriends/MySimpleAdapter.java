...
public class MySimpleAdapter extends SimpleAdapter{
    ...
    public MySimpleAdapter(Context context, List<? extends Map<String, ?>> data, // if fails to compile, do the same replacement as above on this line
                ...
                if (!bound) {
                    ...
                    else if (v instanceof ImageView)
                    {
                        ...
                        if (data instanceof Integer) {
                            ...
                            setViewImageURL((ImageView) v, text);
                        }
    ...
    private void setViewImageURL(ImageView v, String url)
    {
        //System.out.println("ImageView - "+v+"  URL - "+url);
        ...
        {
            new DownloadTask(v,"0", context).execute(url);
        }
